...
#' @param fcr.low Valor Inferior de la FCR. Por defecto el valor es 1.01.
#' @param fcr.mean Valor Promedio de la FCR. Por defecto el valor es 1.02.
#' @param fcr.high Valor Superior de la FCR. Por defecto el valor es 1.04.
#'
...
#'
hia_no2 <-
  function(x, uc = 10, cf, fcr.low = 1.01, fcr.mean = 1.02, fcr.high = 1.04) {
